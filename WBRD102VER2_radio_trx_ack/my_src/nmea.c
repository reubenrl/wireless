...
uint8_t nmeaProcess(cBuffer* rxBuffer)
{
	...
	if(foundpacket)
	{
		...
		//if(!strncmp((char *)NmeaPacket, "GNGGA", 5))
		{
		...
		//else if(!strncmp((char *)NmeaPacket, "GNVTG", 5))
		{
			// process packet of this type
