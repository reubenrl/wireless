...
// BASE_FREQUENCY = 434000000
#define RADIO_USER_INPUT_BASE_FREQUENCY 434000000
// BIT_ORDER = false
#define RADIO_USER_INPUT_BIT_ORDER FALSE
// CENTER_FREQUENCY = 434000000
#define RADIO_USER_INPUT_CENTER_FREQUENCY 434000000
// CHANNEL_NUMBER = 0
...
// CRYSTAL_USE_EXTERNAL_SOURCE = true
#define RADIO_USER_INPUT_CRYSTAL_USE_EXTERNAL_SOURCE TRUE
// DRIVE_STRENGTH = 0
...
// PKT_FIELD_LENGTH[0] = 20
#define RADIO_USER_INPUT_PKT_FIELD_LENGTH[0] 20
...
// PKT_RX_FIELD_LENGTH[0] = 20
#define RADIO_USER_INPUT_PKT_RX_FIELD_LENGTH[0] 20
...
// POWER_PA_POWERLEVEL = 17
#define RADIO_USER_INPUT_POWER_PA_POWERLEVEL 17
...
// RFPARAM_DATA_RATE = 800
#define RADIO_USER_INPUT_RFPARAM_DATA_RATE 800
// RFPARAM_DEVIATION = 800
#define RADIO_USER_INPUT_RFPARAM_DEVIATION 800
...
// RFPARAM_RXBANDWIDTH = 2500
#define RADIO_USER_INPUT_RFPARAM_RXBANDWIDTH 2500
...
// RX_CHECK_CRC[0] = true
#define RADIO_USER_INPUT_RX_CHECK_CRC[0] TRUE
// RX_CHECK_CRC[1] = true
#define RADIO_USER_INPUT_RX_CHECK_CRC[1] TRUE
...
// RX_ENABLE_CRC[0] = true
#define RADIO_USER_INPUT_RX_ENABLE_CRC[0] TRUE
// RX_ENABLE_CRC[1] = true
#define RADIO_USER_INPUT_RX_ENABLE_CRC[1] TRUE
...
// SELECTED_CHIP = si4468~revision[REVA2A]
#define RADIO_USER_INPUT_SELECTED_CHIP si4468~revision[REVA2A]
// SW_CRC_CTRL = false
...
// radio.profile = EZRadioPacketTrxAutoAck
#define CHIP_CONFIG_INPUT_RADIO_PROFILE "EZRadioPacketTrxAutoAck"
...
// Modem.API_RXBW = 2500
#define CHIP_CONFIG_INPUT_MODEM_API_RXBW 2500
...
// Modem.API_Rsymb = 800
#define CHIP_CONFIG_INPUT_MODEM_API_RSYMB 800
...
// Pkt.PKT_RX_FIELD_2_CRC_CONFIG__CRC_ENABLE = true
#define CHIP_CONFIG_INPUT_PKT_PKT_RX_FIELD_2_CRC_CONFIG__CRC_ENABLE TRUE
// Pkt.PKT_RX_FIELD_5_CRC_CONFIG__CHECK_CRC = false
#define CHIP_CONFIG_INPUT_PKT_PKT_RX_FIELD_5_CRC_CONFIG__CHECK_CRC FALSE
// Pkt.PKT_RX_FIELD_1_LENGTH__RX_FIELD_1_LENGTH = 20
#define CHIP_CONFIG_INPUT_PKT_PKT_RX_FIELD_1_LENGTH__RX_FIELD_1_LENGTH 20
...
// Pkt.PKT_FIELD_1_LENGTH__FIELD_1_LENGTH = 20
#define CHIP_CONFIG_INPUT_PKT_PKT_FIELD_1_LENGTH__FIELD_1_LENGTH 20
...
// Pkt.PKT_RX_FIELD_1_CRC_CONFIG__CRC_ENABLE = true
#define CHIP_CONFIG_INPUT_PKT_PKT_RX_FIELD_1_CRC_CONFIG__CRC_ENABLE TRUE
...
// Modem.API_fc = 434000000
#define CHIP_CONFIG_INPUT_MODEM_API_FC 434000000
...
// PowerUp.use_external_tcxo = true
#define CHIP_CONFIG_INPUT_POWERUP_USE_EXTERNAL_TCXO TRUE
...
// Pkt.PKT_RX_FIELD_2_CRC_CONFIG__CHECK_CRC = true
#define CHIP_CONFIG_INPUT_PKT_PKT_RX_FIELD_2_CRC_CONFIG__CHECK_CRC TRUE
// Pkt.PKT_FIELD_5_LENGTH__FIELD_5_LENGTH = 0
#define CHIP_CONFIG_INPUT_PKT_PKT_FIELD_5_LENGTH__FIELD_5_LENGTH 0
// Modem.API_Fdev = 800
#define CHIP_CONFIG_INPUT_MODEM_API_FDEV 800
...
// Pkt.PKT_RX_FIELD_1_CRC_CONFIG__CHECK_CRC = true
#define CHIP_CONFIG_INPUT_PKT_PKT_RX_FIELD_1_CRC_CONFIG__CHECK_CRC TRUE
...
// InterruptControl.INT_CTL_PH_ENABLE__ALT_CRC_ERROR_EN = 0
#define CHIP_CONFIG_INPUT_INTERRUPTCONTROL_INT_CTL_PH_ENABLE__ALT_CRC_ERROR_EN 0
...
// PowerAmplifier.PA_PWR_LVL__DDAC = 17
#define CHIP_CONFIG_INPUT_POWERAMPLIFIER_PA_PWR_LVL__DDAC 17
