...
// if_freq: -406250.0
// nb_filter: 3
// nb_filter_bw: 40.132083333333334
// wb_filter: 3
// wb_filter_bw: 40.132083333333334
...
#define RADIO_CONFIG_SET_PROPERTY_SYNC_BITS2 { \
  0x11 /* CMD: Set property                                  */,\
  0x11 /* GROUP: Sync                                        */,\
  0x04 /* NUM_PROPS                                          */,\
  0x06 /* START_PROP                                         */,\
  0x2D /* SYNC_BITS2,BITS[7:0],BITS[7:0],BITS[7:0],BITS[7:0] */,\
  0xD4 /* DATA1                                              */,\
  0x2D /* DATA2                                              */,\
  0xD4 /* DATA3                                              */\
}

#define RADIO_CONFIG_SET_PROPERTY_SYNC_BITS2_LEN (8)
...
#define RADIO_CONFIG_SET_PROPERTY_PKT_RX_FIELD_1_CRC_CONFIG { \
  ...
  0x01 /* NUM_PROPS                                                                                                             */,\
  0x24 /* START_PROP                                                                                                            */,\
  0x8A /* PKT_RX_FIELD_1_CRC_CONFIG,CRC_START[7],ALT_CRC_START[6],CHECK_CRC[3],CHECK_ALT_CRC[2],CRC_ENABLE[1],ALT_CRC_ENABLE[0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_DATA_RATE { \
  ...
  0x03 /* NUM_PROPS                                                    */,\
  0x03 /* START_PROP                                                   */,\
  0x00 /* MODEM_DATA_RATE,DATA_RATE[7:0],DATA_RATE[7:0],DATA_RATE[7:0] */,\
  0x1F /* DATA1                                                        */,\
  0x40 /* DATA2                                                        */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_FREQ_CONTROL_FRAC { \
  ...
  0x03 /* NUM_PROPS                                       */,\
  0x01 /* START_PROP                                      */,\
  0x0E /* FREQ_CONTROL_FRAC,FRAC[3:0],FRAC[7:0],FRAC[7:0] */,\
  0x27 /* DATA1                                           */,\
  0x62 /* DATA2                                           */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_DECIMATION_CFG1 { \
  ...
  0x01 /* NUM_PROPS                                              */,\
  0x1E /* START_PROP                                             */,\
  0x32 /* MODEM_DECIMATION_CFG1,NDEC2[7:6],NDEC1[5:4],NDEC0[3:1] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_BCR_OSR { \
  ...
  0x02 /* NUM_PROPS                           */,\
  0x22 /* START_PROP                          */,\
  0x03 /* MODEM_BCR_OSR,RXOSR[3:0],RXOSR[7:0] */,\
  0xF8 /* DATA1                               */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_BCR_NCO_OFFSET { \
  ...
  0x03 /* NUM_PROPS                                             */,\
  0x24 /* START_PROP                                            */,\
  0x00 /* MODEM_BCR_NCO_OFFSET,NCOFF[5:0],NCOFF[7:0],NCOFF[7:0] */,\
  0x81 /* DATA1                                                 */,\
  0x0E /* DATA2                                                 */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_AFC_LIMITER { \
  ...
  0x02 /* NUM_PROPS                                 */,\
  0x30 /* START_PROP                                */,\
  0x60 /* MODEM_AFC_LIMITER,AFCLIM[6:0],AFCLIM[7:0] */,\
  0xBD /* DATA1                                     */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_AGC_RFPD_DECAY { \
  ...
  0x01 /* NUM_PROPS                            */,\
  0x39 /* START_PROP                           */,\
  0xDE /* MODEM_AGC_RFPD_DECAY,RFPD_DECAY[7:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_AGC_IFPD_DECAY { \
  ...
  0x01 /* NUM_PROPS                            */,\
  0x3A /* START_PROP                           */,\
  0xDE /* MODEM_AGC_IFPD_DECAY,IFPD_DECAY[7:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_FSK4_TH { \
  ...
  0x02 /* NUM_PROPS                             */,\
  0x3D /* START_PROP                            */,\
  0x80 /* MODEM_FSK4_TH,4FSKTH[7:0],4FSKTH[7:0] */,\
  0x00 /* DATA1                                 */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_OOK_PDTC { \
  ...
  0x01 /* NUM_PROPS                             */,\
  0x40 /* START_PROP                            */,\
  0x2B /* MODEM_OOK_PDTC,ATTACK[6:4],DECAY[3:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_RAW_CONTROL { \
  ...
  0x01 /* NUM_PROPS                                                                */,\
  0x45 /* START_PROP                                                               */,\
  0x81 /* MODEM_RAW_CONTROL,UNSTDPK[7],CONSCHK_BYP[6],PM_PATTERN[3:2],RAWGAIN[1:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_DSA_QUAL { \
  ...
  0x01 /* NUM_PROPS                                   */,\
  0x5D /* START_PROP                                  */,\
  0x07 /* MODEM_DSA_QUAL,EYE_QUAL_SEL[7],ARRQUAL[6:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_DECIMATION_CFG2 { \
  ...
  0x01 /* NUM_PROPS                                */,\
  0x20 /* START_PROP                               */,\
  0x14 /* MODEM_RESERVED_20_20,RESERVED_20_20[7:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_GLOBAL_BUFCLK_CFG { \
  0x11 /* CMD: Set property                                                  */,\
  0x00 /* GROUP: Global                                                      */,\
  0x01 /* NUM_PROPS                                                          */,\
  0x0A /* START_PROP                                                         */,\
  0x00 /* GLOBAL_BUFCLK_CFG,DIV_MODE[7:6],DIVX[5:2],DIVIDED_BUFCLK_MODE[1:0] */\
}

#define RADIO_CONFIG_SET_PROPERTY_GLOBAL_BUFCLK_CFG_LEN (5)
